...
openPrivateMessage = function(pmid, title)
{
	/* create tab element */
	var newTab = "<li id=\"pm_" + pmid + "_tab\"><a data-toggle=\"tab\" href=\"#pm_" + pmid + "_body\"><i class=\"fa fa-fw fa-times close_pm_tab\" data-pmid=\"" + pmid + "\"></i><i class=\"fa fa-lg fa-fw fa-envelope-o\"></i> " + title + "</a></li>";
